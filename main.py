...
if __name__ == '__main__':
    ...
    # if you want to extract the cities from a platform(tazz or glovo) run the following:
    ...
    # if you want to extract all the restaurants from a certain list of cities run the following:
    ...
    # if you want to extract all the menu items from a certain list of restaurants run the following:
    menus_from_certain_restaurants = await scrape_restaurant_menus(restaurant_links, platform='')

    # furthermore, if you want to run all of the above for a platform(tazz or glovo) run the following(it's dark magic):
